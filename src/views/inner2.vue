<template>
  ...
  <div id="inner">
    ...
    <div
      class="safari-float"
      :class="{ 'isSafari-browser': isSafariBrowser }"
    ...
    >
      ...
      <button class="safari-close" @click="closeSafariFloat($event)">
...
import userInfoMask from "./view2/userInfoMask";
import loginBox from "./view2/loginBox";
import accountAndPas from "./view2/accountAndPas";
import passWordLogin from "./view2/passWordLogin";
import phoneLogin from "./view2/phoneLogin";
import customerService from "./view2/customerService";
import wechat from "./view2/wechat";
import email from "./view2/email";
import emailDetails from "./view2/emailDetails";
import reconiseInfo from "./view2/reconiseInfo";
import bindPhone from "./view2/bindPhone";
import coupon from "./view2/coupon";
import payType from "./view2/payType";
import register from "./view2/register";
import wallet from "./view2/wallet";
import antiAddiction from "./view2/antiAddiction";

import agreement from "./view2/agreement"; //用户协议
import account from "./view2/account";
import alertPwd from "./view2/alertPwd";
...
export default {
  ...
  data() {
    return {
      ...
      // gzhIcon: require("../assets/img/jrxy.jpg"), //今日新游推送公众号
