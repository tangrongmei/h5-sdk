...
export default {
  ...
  data() {
    return {
      ...
      // logoImg: require("../../assets/img/logo.png"), //海象logo
      // logoImg: require("../../assets/img/cmLogo.png"), //草莓logo
      logoImg: require("../../assets/img/hmLogo.png"), //虹猫logo
      baseImg: "",
    };
  },
  creater() {},
