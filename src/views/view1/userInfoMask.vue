  ...
  <div class="userInfoMask winBox">
    <div class="header" v-if="showType == 'vertical'">
      <div class="header_Icon" @click="outHeader">
        <img :src="userData.header1" v-if="isOutHeader" alt />
        <img :src="userData.header1" v-else alt />
      </div>
      <div class="header_r">
    ...
    <div class="content">
      <div class="list">
        ...
        <div class="listItem" @click="toWallet">
          <img class="dataIcon" :src="walletIcon" alt />
          <span class="dataTitle">钱包</span>
          <div
            class="redDot"
            v-if="isFirstLoginData.wallet == 0 || redCountData.walletCount > 0"
          >
            <span v-if="redCountData.walletCount > 0">{{
              redCountData.walletCount
            }}</span>
          </div>
        </div>
        <div class="listItem" @click="toWelfare">
          <img class="dataIcon" :src="welfareIcon" alt />
          <span class="dataTitle">福利任务</span>
          <div
            class="redDot"
            v-if="
              isFirstLoginData.welfare == 0 || redCountData.welfareTaskCount > 0
            "
          >
            <span v-if="redCountData.welfareTaskCount > 0">{{
              redCountData.welfareTaskCount
            }}</span>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      userData: {
        ...
        // header1: require("../../assets/img/logo.png"),
        header1: require("../../assets/img/cmLogo.png"),
      },
      userInfo: {},
      newestMessage: {},
      showType: "vertical",
      ...
      welfareIcon: require("../../assets/img/welfare.png"),
  ...
  methods: {
    ...
    toWelfare() {
      if (this.isFirstLoginData.welfare == 0) {
        this.$store.commit("postOtherWelfareRed", "1");
        this.postRedStatus(88);
      }
      this.switchContent("IsWelfareFun");
      this.$store.commit("clickWelfare");
    },
    toBindPhone() {
