...
export default {
  ...
  mounted() {
    ...
    this.device_params.idfa = localStorage.getItem("idfa") ? localStorage.getItem("idfa") : ""; //ios壳包专用参数
    this.device_params.os = localStorage.getItem("os") ? localStorage.getItem("os") : ""; //ios壳包专用参数
