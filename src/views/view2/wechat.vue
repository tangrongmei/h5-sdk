<template>
  <div class="wechat">
    ...
    <div class="wechatContent">
      <span>关注官方公众号，领取福利礼包</span>
      <img :src="gzhIcon" alt />
      <span>公众号：今日新游推送</span>
      <span>长按二维码一键关注</span>

    </div>
    <div class="copyBtn" @click="copy" @mouseenter="copy()" ref="btn" data-clipboard-text="今日新游推送">
      <span>点击复制</span>
    </div>
...
export default {
  ...
  methods: {
    back() {
      this.$store.dispatch("IsWechatFun", false);
